#ifndef _ROS_vision_parameterbutton_h
#define _ROS_vision_parameterbutton_h
...
namespace vision
{
  ...
  class parameterbutton : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "vision/parameterbutton"; };
