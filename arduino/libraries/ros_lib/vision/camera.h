#ifndef _ROS_vision_camera_h
#define _ROS_vision_camera_h
...
namespace vision
{
  ...
  class camera : public ros::Msg
  {
    ...
    const char * getType(){ return "vision/camera"; };
    const char * getMD5(){ return "0744f9079f53d1596660372505b379c3"; };
