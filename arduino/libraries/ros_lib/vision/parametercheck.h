#ifndef _ROS_vision_parametercheck_h
#define _ROS_vision_parametercheck_h
...
namespace vision
{
  ...
  class parametercheck : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "vision/parametercheck"; };
