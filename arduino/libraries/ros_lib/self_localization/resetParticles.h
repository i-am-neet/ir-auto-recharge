#ifndef _ROS_self_localization_resetParticles_h
#define _ROS_self_localization_resetParticles_h
...
namespace self_localization
{
  ...
  class resetParticles : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "self_localization/resetParticles"; };
    const char * getMD5(){ return "26895eb96730d7ef682978f05897afa1"; };
