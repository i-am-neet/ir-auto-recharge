#ifndef _ROS_nubot_common_Angle_h
#define _ROS_nubot_common_Angle_h
...
namespace nubot_common
{
  ...
  class Angle : public ros::Msg
  {
    ...
    const char * getType(){ return "nubot_common/Angle"; };
    const char * getMD5(){ return "7328b114b91e2487fcf12e1581a80145"; };
